...
function home() {
  document.getElementById("inner").innerHTML = `<section class="home" id="home">
  ...
  <h3 class="home__title">Contexto</h3>
  <div class="home__sec">
  ...
  eléctricos y electrónicos de una manera económica, técnica y ambientalmente más eficiente que el reciclaje.</p>
  </div>
  </div>
  </article>
  </section>`;
...
function carousel() {
  document.getElementById(
    "inner"
  ).innerHTML = `<section class="carousel-area" id="carousel">
  <div class="container">
  <div class="row">
  <div class="col s12">
...
function about() {
  document.getElementById(
    "inner"
  ).innerHTML = `<section class="about" id="about">
...
function donate() {
  document.getElementById(
    "inner"
  ).innerHTML = `<section class="donate" id="donate">
...
function points() {
  document.getElementById(
    "inner"
  ).innerHTML = `<section class="points" id="points">
  <h2 class="points__head">Puntos de Entrega</h2>
  <article class="points__cont">
    <div class="iframe-div" style="height:500px; width:100%; display:inline-block; overflow:hidden;">
...
function contact() {
  document.getElementById(
    "inner"
  ).innerHTML = `<section class="form__cont" id="contact">
  ...
  <input for="lastname" type="text" name="lastname" placeholder="Tu apellido">
  </div>
  <div class="form__cont--item form__cont--item3">
  <label for="email">Email <sup>*</sup></label>
  <input id="email" type="email" name="email" placeholder="ej. ejemplo@email.com">
  <span id="email-ok" name="email-ok"></span>
  </div>
  <div class="form__cont--item form__cont--item4">
  <label for="phonenumber">Teléfono</label>
  <input id="phonenumber" type="tel" name="phonenumber" placeholder="ej. 11 5 1234567">
  </div>
  ...
  <input type="text" name="other" id="otro" style="display: none;">
  </div>
  <div class="form__cont--textarea form__cont--text">
  <label for="message">Mensaje <sup>*</sup></label>
  <textarea id="message" type="text" name="message" maxlength="300"
